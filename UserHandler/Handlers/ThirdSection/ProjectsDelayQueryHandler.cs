...
namespace UserHandler.Handlers.ThirdSection
{
    public class ProjectsDelayQueryHandler : IRequestHandler<ProjectsDelayQuery, ProjectsDelayQueryResult>
    {
        ...
        public ProjectsDelayQueryHandler(IRepository<Organizations, int> organization, IRepository<Deadline, int> deadline, IRepository<Field, int> field, IRepository<DelaysOnProjects, int> delaysOnProjects)
        {
