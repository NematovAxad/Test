...
{
    public partial class cybersecurityexpertdecision : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "reestr_project_cyber_security_expert_decsion",
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_reestr_project_cyber_security_expert_decsion", x => x.id);
                    table.ForeignKey(
                        name: "FK_reestr_project_cyber_security_expert_decsion_organization_o~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_reestr_project_cyber_security_expert_decsion_organization_id",
                schema: "reestrprojects",
