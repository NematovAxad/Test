...
namespace MainInfrastructures.Migrations
{
    ...
    [Migration("20231124043608_newtables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.ContentManager", b =>
                {
                    ...
                    b.Property<string>("UserPinfl")
                        .HasColumnName("user_pinfl")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.Models.FifthSection.ReestrModels.ReestrProjectPassport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<bool>("HasExpertise")
                        .HasColumnName("has_expertise")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasTerms")
                        .HasColumnName("has_terms")
                        .HasColumnType("boolean");

                    b.Property<string>("LinkForSystem")
                        .HasColumnName("link_for_system")
                        .HasColumnType("text");
                    ...
                    b.ToTable("reestr_project_passport","reestrprojects");
                });

            modelBuilder.Entity("Domain.Models.FifthSection.ReestrModels.ReestrProjectPassportDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<string>("BasisName")
                        .HasColumnName("basis_name")
                        .HasColumnType("text");

                    b.Property<string>("CybersecurityExpertise")
                        .HasColumnName("cybersecurity_expertise")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("IsInterdepartmentalInformationSystem")
                        .HasColumnName("is_interdepartmental_information_system")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("reestr_project_passport_details","reestrprojects");
                });
            ...
            modelBuilder.Entity("Domain.Models.FirstSection.NewsOnDashboard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.ToTable("news_on_dashboard","organizations");
                });
            ...
            modelBuilder.Entity("Domain.Models.FirstSection.OrganizationEmployeeAttestats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.ToTable("organization_employee_attestats","organizations");
                });
            ...
            modelBuilder.Entity("Domain.Models.MygovModels.MygovExceptionCases", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<int>("MygovServiceId")
                        .HasColumnName("mygov_service_id")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("mygov_exception_cases","organizations");
                });
            ...
            modelBuilder.Entity("Domain.Models.SecondSection.OpenDataTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<DateTime>("TableLastUpdateDate")
                        .HasColumnName("table_last_update_date")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.ToTable("open_data_table","opendata");
                });
            ...
            modelBuilder.Entity("Domain.Models.SecondSection.OrganizationSocials", b =>
                {
                    ...
                    b.Property<string>("PoolCommentExpert")
                        .HasColumnName("pool_comment_expert")
                        .HasColumnType("text");

                    b.Property<bool?>("PoolExceptExpert")
                        .HasColumnName("pool_except_expert")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.Models.SixthSection.OrganizationDigitalEconomyProjectsDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<string>("NormativeDocumentNumber")
                        .HasColumnName("normative_document_number")
                        .HasColumnType("text");
                    ...
                    b.ToTable("organization_digital_economy_projects_detail","organizations");
                });
