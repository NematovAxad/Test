            ...
            modelBuilder.Entity("Domain.Models.SecondSection.ProjectConnections", b =>
                {
                    ...
                    b.Property<int>("ReestrProjectConnectionId")
                        .HasColumnName("reestr_project_connection_id")
                        .HasColumnType("integer");

                    b.Property<int>("ReestrProjectConnectionType")
                        .HasColumnName("connection_type")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("ReestrProjectConnectionId");
            ...
            modelBuilder.Entity("Domain.Models.SecondSection.ProjectConnections", b =>
                {
                    b.HasOne("Domain.Models.SecondSection.ReestrProjectConnection", "ReestrProjectConnection")
                        ...
                        .HasForeignKey("ReestrProjectConnectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
