...
namespace MainInfrastructures.Services
{
    public class OrganizationService : IOrganizationService
    {
        ...
        private async Task SetReestrData(ExcelWorksheet worksheet, int orgId)
        {
            ...
            worksheet.Cells[27, 2].Value = reestrResult.Items.Count.ToString(CultureInfo.InvariantCulture);
            ...
            worksheet.Cells[28, 2].Value = reestrResult.Items.Where(i=>i.HasExpertise == true).ToList().Count.ToString(CultureInfo.InvariantCulture);
